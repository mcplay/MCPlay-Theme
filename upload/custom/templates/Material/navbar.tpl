<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
  <div class="container">
	...
	<span class="navbar-brand mb-0 h1">MCPlayNetwork</span>
		...
		{* Dropdown *}
			<li class="nav-item dropdown">
				...
				{if isset($LOGGED_IN_USER)}
            		<img src="{$LOGGED_IN_USER.avatar}" alt="{$LOGGED_IN_USER.username}" class="rounded" style="max-height:25px;max-width:25px;"/>
            	{/if}
                {$item.title}
				</a>
				<div class="dropdown-menu dropdown-menu-right">
